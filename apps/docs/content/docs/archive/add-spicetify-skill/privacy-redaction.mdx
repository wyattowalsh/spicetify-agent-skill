...
description: Migrated /spicetify planning content for Privacy and redaction.
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/privacy-redaction.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/privacy-redaction.mdx`
