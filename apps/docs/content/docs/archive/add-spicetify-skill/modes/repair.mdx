...
section: modes
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/modes/repair.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/modes/repair.mdx`
...
Primary contracts: `operation-plan, snapshot-manifest, verification-report`. Any implementation-specific schema expansion MUST update `apps/docs/content/docs/archive/add-spicetify-skill/schemas/index.mdx`, `api-contracts.md`, and regression prompts.
