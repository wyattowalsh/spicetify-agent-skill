---
title: Mode: uninstall
description: Migrated /spicetify planning content for Mode: uninstall.
section: modes
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/modes/uninstall.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/modes/uninstall.mdx`
...
Primary contracts: `operation-plan, snapshot-manifest, policy-decision`. Any implementation-specific schema expansion MUST update `apps/docs/content/docs/archive/add-spicetify-skill/schemas/index.mdx`, `api-contracts.md`, and regression prompts.
