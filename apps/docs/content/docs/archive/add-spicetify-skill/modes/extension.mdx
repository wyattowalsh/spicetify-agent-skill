---
title: Mode: extension
description: Migrated /spicetify planning content for Mode: extension.
section: modes
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/modes/extension.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/modes/extension.mdx`
