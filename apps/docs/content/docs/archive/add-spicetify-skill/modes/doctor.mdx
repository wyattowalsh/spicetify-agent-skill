---
title: Mode: doctor
description: Migrated /spicetify planning content for Mode: doctor.
section: modes
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/modes/doctor.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/modes/doctor.mdx`
