---
title: Workflow: state, snapshots, restore, and rollback
description: Migrated /spicetify planning content for Workflow: state, snapshots, restore, and rollback.
section: workflows
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/workflows/state-snapshots-rollback.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/workflows/state-snapshots-rollback.mdx`
