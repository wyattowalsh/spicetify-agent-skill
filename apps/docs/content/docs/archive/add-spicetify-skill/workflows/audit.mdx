---
title: Workflow: third-party and generated-code audit
description: Migrated /spicetify planning content for Workflow: third-party and generated-code audit.
section: workflows
source: migrated
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/workflows/audit.mdx`
