---
title: Codex tooling notes
description: Migrated /spicetify planning content for Codex tooling notes.
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/codex-tooling.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/codex-tooling.mdx`
