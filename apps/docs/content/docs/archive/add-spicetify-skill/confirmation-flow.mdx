...
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/confirmation-flow.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/confirmation-flow.mdx`
