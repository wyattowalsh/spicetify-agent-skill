...
section: reference
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/schemas/index.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/schemas/index.mdx`
