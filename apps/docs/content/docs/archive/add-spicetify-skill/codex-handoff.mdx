...
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/codex-handoff.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/codex-handoff.mdx`
...
9. `apps/docs/content/docs/archive/add-spicetify-skill/policy-matrix.mdx`, `apps/docs/content/docs/archive/add-spicetify-skill/privacy-redaction.mdx`, `apps/docs/content/docs/archive/add-spicetify-skill/desired-state-manifest.mdx`
10. `apps/docs/content/docs/archive/add-spicetify-skill/invariants.mdx`
11. `apps/docs/content/docs/archive/add-spicetify-skill/failure-recovery-catalog.mdx`
12. `apps/docs/content/docs/archive/add-spicetify-skill/cli-ux-contract.mdx`
13. `apps/docs/content/docs/archive/add-spicetify-skill/operation-state-machine.mdx`
14. `apps/docs/content/docs/archive/add-spicetify-skill/provenance-lockfile.mdx`
15. `apps/docs/content/docs/archive/add-spicetify-skill/plans.mdx`
