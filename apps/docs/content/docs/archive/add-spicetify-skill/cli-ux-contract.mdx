---
title: CLI and conversational UX contract
description: Migrated /spicetify planning content for CLI and conversational UX contract.
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/cli-ux-contract.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/cli-ux-contract.mdx`
