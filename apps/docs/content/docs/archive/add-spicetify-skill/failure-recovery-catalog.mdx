---
title: Failure recovery catalog
description: Migrated /spicetify planning content for Failure recovery catalog.
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/failure-recovery-catalog.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/failure-recovery-catalog.mdx`
