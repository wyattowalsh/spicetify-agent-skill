---
title: Mode catalog
description: Migrated /spicetify planning content for Mode catalog.
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/mode-catalog.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/mode-catalog.mdx`
...
Each mode has a dedicated file under `apps/docs/content/docs/archive/add-spicetify-skill/modes/` with inputs, preconditions, files touched, safety, plan, execution, verification, rollback, prompts, and structured response.
