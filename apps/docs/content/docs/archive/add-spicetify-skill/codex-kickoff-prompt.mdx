...
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/codex-kickoff-prompt.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/codex-kickoff-prompt.mdx`
...
7. `apps/docs/content/docs/archive/add-spicetify-skill/subagent-task-graph.mdx`
8. `apps/docs/content/docs/archive/add-spicetify-skill/context-map.mdx`
9. `apps/docs/content/docs/archive/add-spicetify-skill/plans.mdx`
10. `apps/docs/content/docs/archive/add-spicetify-skill/validation.mdx`
11. `apps/docs/content/docs/archive/add-spicetify-skill/codex-tooling.mdx`

First action: do read-only preflight. Confirm repository layout, package manager, current OpenSpec files, test commands, and write scopes. Update `apps/docs/content/docs/archive/add-spicetify-skill/context-map.mdx` and `PLANS.md` only if this task has write permission.
...
- `apps/docs/content/docs/archive/add-spicetify-skill/context-map.mdx`
- `apps/docs/content/docs/archive/add-spicetify-skill/plans.mdx`
- `apps/docs/content/docs/archive/add-spicetify-skill/validation.mdx`
