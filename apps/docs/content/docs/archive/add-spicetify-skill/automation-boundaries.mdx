...
description: Migrated /spicetify planning content for Automation boundaries.
section: planning
source: migrated
sourcePath: apps/docs/content/docs/archive/add-spicetify-skill/automation-boundaries.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `apps/docs/content/docs/archive/add-spicetify-skill/automation-boundaries.mdx`
