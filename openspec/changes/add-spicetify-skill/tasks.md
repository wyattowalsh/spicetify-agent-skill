...
- [ ] TASK-001-read-context
  ...
  - Read: `AGENTS.md`, `README.md`, `manifest.md`, `docs/content/docs/archive/add-spicetify-skill/audit-review.mdx`, `source-refresh.md`, `proposal.md`, `design.md`, `specs/`, `context-map.md`
  - Write scope: none
...
- [ ] TASK-002-ground-target-repo
  ...
  - Write scope: `docs/content/docs/archive/add-spicetify-skill/context-map.mdx`
...
- [ ] TASK-003-refresh-current-sources
  ...
  - Write scope: `docs/content/docs/archive/add-spicetify-skill/source-refresh.mdx`, `research.md`, `context-map.md`
...
- [ ] TASK-010-add-core-schemas [P]
  ...
  - Read: `skills/spicetify/assets/schemas/*.schema.json`, `api-contracts.md`, OpenSpec specs
  - Write scope: `skills/spicetify/assets/schemas/`, `tests/schemas/`
...
- [ ] TASK-011-add-command-registry-contracts [P]
  ...
  - Write scope: `skills/spicetify/scripts/_commands.py`, `skills/spicetify/scripts/_runner.py`, `tests/unit/test_command_registry.py`, command-policy tests
...
- [ ] TASK-013-implement-policy-engine [P]
  ...
  - Write scope: `skills/spicetify/scripts/_policy.py`, policy tests
...
- [ ] TASK-014-add-platform-diagnostics [P]
  ...
  - Write scope: `skills/spicetify/scripts/_platform.py`, `skills/spicetify/scripts/_modes.py`, platform/doctor tests
...
- [ ] TASK-015-add-provenance-lock [P]
  ...
  - Write scope: `skills/spicetify/scripts/_provenance.py`, provenance tests
...
- [ ] TASK-016-add-privacy-and-consent-contracts [P]
  ...
  - Depends on: TASK-010-add-core-schemas
  - Read: `privacy-redaction.md`, `specs/privacy/spec.md`, `skills/spicetify/assets/schemas/redaction-policy.schema.json`, `skills/spicetify/assets/schemas/consent-grant.schema.json`
  - Write scope: `skills/spicetify/scripts/_privacy.py`, `skills/spicetify/scripts/_reports.py`, privacy/report tests
...
- [ ] TASK-017-add-desired-state-manifest [P]
  ...
  - Read: `desired-state-manifest.md`, `automation-boundaries.md`, `specs/manifest/spec.md`, `specs/automation/spec.md`, `skills/spicetify/assets/schemas/desired-state-manifest.schema.json`
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_asset_plans.py`, manifest/automation tests
...
- [ ] TASK-018-add-scaffold-template-contracts [P]
  ...
  - Write scope: `skills/spicetify/scripts/_asset_templates.py`, `skills/spicetify/scripts/_asset_plans.py`, scaffold contract tests
...
- [ ] TASK-019-add-invariant-and-recovery-contracts [P]
  ...
  - Read: `invariants.md`, `failure-recovery-catalog.md`, `specs/recovery/spec.md`, `skills/spicetify/assets/schemas/invariant.schema.json`, `skills/spicetify/assets/schemas/failure-recovery.schema.json`
  - Write scope: `skills/spicetify/scripts/_policy.py`, `skills/spicetify/scripts/_state.py`, recovery/policy tests
...
- [ ] TASK-020-implement-skill-router
  ...
  - Write scope: `skills/spicetify/SKILL.md`, `skills/spicetify/scripts/_intent_router.py`, `skills/spicetify/scripts/_modes.py`, intent tests
...
- [ ] TASK-021-implement-inspect-doctor-report
  ...
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_platform.py`, `skills/spicetify/scripts/_reports.py`, inspect/doctor integration tests
...
- [ ] TASK-022-implement-audit-readonly
  ...
  - Write scope: `skills/spicetify/scripts/_audit.py`, `skills/spicetify/scripts/_asset_inspectors.py`, audit tests
...
- [ ] TASK-024-implement-confirmation-contract
  ...
  - Depends on: TASK-010-add-core-schemas, TASK-013-implement-policy-engine
  - Read: `skills/spicetify/assets/schemas/confirmation.schema.json`, `docs/content/docs/archive/add-spicetify-skill/confirmation-flow.mdx`, `specs/policy/spec.md`, `specs/state/spec.md`
...
- [ ] TASK-025-implement-redaction-boundaries
  ...
  - Depends on: TASK-010-add-core-schemas, TASK-013-implement-policy-engine
  - Read: `docs/content/docs/archive/add-spicetify-skill/privacy-redaction.mdx`, `specs/policy/spec.md`, `specs/verification/spec.md`
...
- [ ] TASK-030-implement-snapshot-store
  ...
  - Write scope: `skills/spicetify/scripts/_state.py`, state tests
...
- [ ] TASK-031-implement-config-model
  ...
  - Write scope: `skills/spicetify/scripts/_commands.py`, `skills/spicetify/scripts/_modes.py`, config tests
...
- [ ] TASK-032-implement-profile-switching
  ...
  - Read: `modes/profile.md`, `skills/spicetify/assets/schemas/profile.schema.json`
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_provenance.py`, profile tests
...
- [ ] TASK-040-implement-apply-and-rollback
  ...
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_runner.py`, `skills/spicetify/scripts/_state.py`, `skills/spicetify/scripts/_verify.py`, apply/rollback integration tests
...
- [ ] TASK-041-implement-theme-workflow
  ...
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_asset_templates.py`, `skills/spicetify/scripts/_asset_plans.py`, theme tests
...
- [ ] TASK-042-implement-repair-spotify-update
  ...
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_platform.py`, repair tests
...
- [ ] TASK-050-implement-extension-custom-app-scaffolds
  ...
  - Write scope: `skills/spicetify/scripts/_asset_templates.py`, `skills/spicetify/scripts/_asset_plans.py`, `skills/spicetify/scripts/_modes.py`, scaffold tests
...
- [ ] TASK-051-implement-snippet-marketplace-safe-flows
  ...
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_asset_research.py`, `skills/spicetify/scripts/_asset_sources.py`, marketplace/snippet tests
...
- [ ] TASK-052-implement-devtools-watch-update-migrate-uninstall
  ...
  - Write scope: `skills/spicetify/scripts/_modes.py`, `skills/spicetify/scripts/_policy.py`, advanced-mode tests
...
- [ ] TASK-061-add-operation-reports [P]
  ...
  - Read: `skills/spicetify/assets/schemas/operation-report.schema.json`, `skills/spicetify/assets/schemas/verification-report.schema.json`, `privacy-redaction.md`
  - Write scope: `skills/spicetify/scripts/_reports.py`, `skills/spicetify/scripts/_privacy.py`, report tests
...
- [ ] TASK-071-implement-docs-content-source
  ...
  - Write scope: approved docs app root such as `docs/`, generated docs directory, docs package metadata
...
- [ ] TASK-073-implement-docs-generated-references-search-llms
  ...
  - Read: `skills/spicetify/assets/schemas/`, `modes/`, `specs/`, `traceability.md`, Fumadocs search and LLM docs
...
- [ ] TASK-080-add-subagent-task-graph [P]
  ...
  - Depends on: TASK-002-ground-target-repo
  - Read: `docs/content/docs/archive/add-spicetify-skill/codex-tooling.mdx`, `docs/content/docs/archive/add-spicetify-skill/context-map.mdx`, `specs/agents/spec.md`
  - Write scope: `docs/content/docs/archive/add-spicetify-skill/subagent-task-graph.mdx`, `skills/spicetify/assets/schemas/subagent-task-graph.schema.json`, `skills/spicetify/assets/schemas/subagent-result.schema.json`
...
- [ ] TASK-081-add-codex-kickoff-prompt [P]
  ...
  - Write scope: `docs/content/docs/archive/add-spicetify-skill/codex-kickoff-prompt.mdx`, `docs/content/docs/archive/add-spicetify-skill/codex-handoff.mdx`, `docs/content/docs/archive/add-spicetify-skill/goal.mdx`
...
- [ ] TASK-082-add-subagent-validation-and-evals [P]
  ...
  - Read: `validation.md`, `eval-stack.md`, `evals/regression-prompts.json`, `evals/spicetify-eval-suite.json`, `skills/spicetify/assets/schemas/eval-*.schema.json`, `tools/validate_bundle.py`
...
- [ ] TASK-095-prepare-archive-readiness
  ...
  - Depends on: TASK-090-run-validation
  - Write scope: `docs/content/docs/archive/add-spicetify-skill/validation.mdx`, `docs/content/docs/archive/add-spicetify-skill/acceptance-matrix.mdx`, `PLANS.md`
