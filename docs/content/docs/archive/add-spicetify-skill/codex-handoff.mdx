---
title: Codex handoff: implement `/spicetify`
description: Migrated /spicetify planning content for Codex handoff: implement `/spicetify`.
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/codex-handoff.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/codex-handoff.mdx`
...
- All emitted JSON contracts validate against `skills/spicetify/assets/schemas/*.schema.json`.
...
9. `docs/content/docs/archive/add-spicetify-skill/policy-matrix.mdx`, `docs/content/docs/archive/add-spicetify-skill/privacy-redaction.mdx`, `docs/content/docs/archive/add-spicetify-skill/desired-state-manifest.mdx`
10. `docs/content/docs/archive/add-spicetify-skill/invariants.mdx`
11. `docs/content/docs/archive/add-spicetify-skill/failure-recovery-catalog.mdx`
12. `docs/content/docs/archive/add-spicetify-skill/cli-ux-contract.mdx`
13. `docs/content/docs/archive/add-spicetify-skill/operation-state-machine.mdx`
14. `docs/content/docs/archive/add-spicetify-skill/provenance-lockfile.mdx`
15. `docs/content/docs/archive/add-spicetify-skill/plans.mdx`
...
`pyproject.toml`, repo-level scripts, skill-local schemas under
`skills/spicetify/assets/schemas/`, and generated docs references must be edited
sequentially, with validation evidence recorded in `PLANS.md`.
...
Use `suiteKind: canonical` for the full local suite and `suiteKind: focused` for scoped routing or research suites. Focused suites may allow unused fixtures, but hard-safety, route, policy, redaction, and planned artifact checks remain blocking. Eval artifact checks validate planned report schemas/artifacts unless fake execution is explicitly enabled.
