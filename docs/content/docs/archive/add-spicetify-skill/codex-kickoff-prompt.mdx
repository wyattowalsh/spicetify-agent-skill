---
title: Codex kickoff prompt for the `/spicetify` swarm
description: Migrated /spicetify planning content for Codex kickoff prompt for the `/spicetify` swarm.
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/codex-kickoff-prompt.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/codex-kickoff-prompt.mdx`
...
7. `docs/content/docs/archive/add-spicetify-skill/subagent-task-graph.mdx`
8. `docs/content/docs/archive/add-spicetify-skill/context-map.mdx`
9. `docs/content/docs/archive/add-spicetify-skill/plans.mdx`
10. `docs/content/docs/archive/add-spicetify-skill/validation.mdx`
11. `docs/content/docs/archive/add-spicetify-skill/codex-tooling.mdx`

First action: do read-only preflight. Confirm repository layout, package manager, current OpenSpec files, test commands, and write scopes. Update `docs/content/docs/archive/add-spicetify-skill/context-map.mdx` and `PLANS.md` only if this task has write permission.
...
- `docs/content/docs/archive/add-spicetify-skill/context-map.mdx`
- `docs/content/docs/archive/add-spicetify-skill/plans.mdx`
- `docs/content/docs/archive/add-spicetify-skill/validation.mdx`
