---
title: Workflow: command abstraction
description: Migrated /spicetify planning content for Workflow: command abstraction.
section: workflows
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/workflows/command-abstraction.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/workflows/command-abstraction.mdx`
...
Schemas: `skills/spicetify/assets/schemas/command-registry.schema.json` and `skills/spicetify/assets/schemas/command-invocation.schema.json`.
