...
section: workflows
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/workflows/docs-site.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/workflows/docs-site.mdx`
