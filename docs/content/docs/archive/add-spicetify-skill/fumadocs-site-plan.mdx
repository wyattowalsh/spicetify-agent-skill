---
title: Fumadocs site plan
description: Migrated /spicetify planning content for Fumadocs site plan.
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/fumadocs-site-plan.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/fumadocs-site-plan.mdx`
...
- `sync-openspec-content.ts` reads local files only and writes only under `docs/content/docs/generated/` unless explicitly approved.
