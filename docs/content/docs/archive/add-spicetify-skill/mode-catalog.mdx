...
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/mode-catalog.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/mode-catalog.mdx`
...
Each mode has a dedicated file under `docs/content/docs/archive/add-spicetify-skill/modes/` with inputs, preconditions, files touched, safety, plan, execution, verification, rollback, prompts, and structured response.
