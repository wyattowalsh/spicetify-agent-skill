...
section: modes
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/modes/manifest.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/modes/manifest.mdx`
...
Primary contracts: `desired-state-manifest, asset-manifest, profile, operation-plan`. Any implementation-specific schema expansion MUST update `docs/content/docs/archive/add-spicetify-skill/schemas/index.mdx`, `api-contracts.md`, and regression prompts.
