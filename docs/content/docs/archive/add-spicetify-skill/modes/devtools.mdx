...
section: modes
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/modes/devtools.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/modes/devtools.mdx`
...
Primary contracts: `consent-grant, redaction-policy, operation-report`. Any implementation-specific schema expansion MUST update `docs/content/docs/archive/add-spicetify-skill/schemas/index.mdx`, `api-contracts.md`, and regression prompts.
