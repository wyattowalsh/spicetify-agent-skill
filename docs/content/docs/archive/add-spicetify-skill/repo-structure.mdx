...
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/repo-structure.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/repo-structure.mdx`
  ...
  skills/
    spicetify/
      ...
      scripts/
        ...
        _*.py
      assets/
        schemas/             # canonical JSON schema assets
          *.schema.json
      agents/
  evals/
...
- The docs app uses Node tooling only under `docs` and must not become a
