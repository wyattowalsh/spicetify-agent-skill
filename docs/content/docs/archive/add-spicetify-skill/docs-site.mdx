---
title: Companion docs site plan
description: Migrated /spicetify planning content for Companion docs site plan.
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/docs-site.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/docs-site.mdx`
