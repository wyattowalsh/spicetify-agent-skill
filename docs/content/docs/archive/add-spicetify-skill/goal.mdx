...
section: planning
source: migrated
sourcePath: docs/content/docs/archive/add-spicetify-skill/goal.mdx
owner: docs
status: migrated
safetyLevel: read
---
...
**Path:** `docs/content/docs/archive/add-spicetify-skill/goal.mdx`
...
## Read first
0. `docs/content/docs/archive/add-spicetify-skill/codex-kickoff-prompt.mdx` for Codex swarm kickoff.
0. `docs/content/docs/archive/add-spicetify-skill/subagent-task-graph.mdx` for bounded subagent assignments.
...
5. `docs/content/docs/archive/add-spicetify-skill/plans.mdx`
6. `docs/content/docs/archive/add-spicetify-skill/mvp-cutline.mdx`
7. `docs/content/docs/archive/add-spicetify-skill/policy-matrix.mdx`, `docs/content/docs/archive/add-spicetify-skill/privacy-redaction.mdx`, `docs/content/docs/archive/add-spicetify-skill/desired-state-manifest.mdx`
8. `docs/content/docs/archive/add-spicetify-skill/codex-handoff.mdx`
...
Update `docs/content/docs/archive/add-spicetify-skill/plans.mdx` after each meaningful step with progress, discoveries, decisions, validation, changed files, and unresolved risks.
...
The accompanying docs app is now present under `docs`. Future docs-site
